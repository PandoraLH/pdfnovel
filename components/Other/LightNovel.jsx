...
const LightNovel = ({
  ...
  return (
    <div
      className={`lightnovel-container flex items-center ${
        bottomBorder ? "border-b-[5px]" : ""
      } mb-3 pb-3`}
    >
      ...
      <div className="font-poppins ml-5 object-contain mr-5">
        <div className="cursor-pointer font-bold text-2xl lg:text-3xl text-blue-700 hover:opacity-60 transition-opacity duration-500 ease-in-out">
          {title}
        </div>
